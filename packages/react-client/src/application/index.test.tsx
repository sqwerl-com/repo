          ...
          members: [
            {
              ...
              isSummary: true,
              name: 'Collections of related things',
    ...
    fetchMocker.mockResponseOnce(
      JSON.stringify({
        ...
        canWrite: {
          ...
          members: [
            {
              href: 'http://localhost:6719/Main/tcarroll/types/contributors/tcarroll',
        ...
        shortDescription: 'The things that make people smart',
