import aggregateToChangesByDay, { AggregatedRepositoryChange } from '@/utils/repository-change-aggregator'
...
const RepositoriesSheet = (props: SheetProps): React.JSX.Element => {
  logger = Logger(RepositoriesSheet, RepositoriesSheet)
  const { state } = props
...
const renderSelectedDaysChanges = (
  intl: IntlShape, changes: AggregatedRepositoryChange[], props: SheetProps, state: SheetState) => {
