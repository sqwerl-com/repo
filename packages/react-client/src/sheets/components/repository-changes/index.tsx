...
const RepositoryChanges = (props: Props): React.JSX.Element => {
  ...
  if (changes) {
    ...
    changes.forEach((change, index) => {
      const linkTarget =
        (change.isCollection
          ? linkTargetToCollection(change.id, configuration, context, currentRepositoryName)
          : linkTargetToLeaf(change.id, configuration, context, currentRepositoryName))
...
/**
 * Renders a table row that describes a thing that has been removed from a repository of things.
 * @param renderContext Information required to describe changes made to a thing.
 */
