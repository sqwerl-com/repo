...
/**
 * Renders title text for changes made to a repository of things by more than one person.
...
/**
 * Renders title text for changes made to a repository of things by a single individual.
 * @param changedBy
 * @param changesCount
 * @param date
 * @param shouldShowRelativeTime Display a textual description of the distance of the given date from now.
