/**
 * Is the given date close enough too now to display a relative time description (one hour ago, a week ago, etc.)?
 * @param timestamp The time when a changes were made to a repository of things.
