...
import { mockApplicationConfiguration, mockApplicationContext } from '@/utilities/mocks'
...
it('creates link to a collection of things', () => {
  ...
  expect(linkTargetToCollection(
    ...
    repositoryName)).toEqual(
      `/${repositoryName}/types/collections/Things to Check Out#` +
