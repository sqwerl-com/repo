...
Sqwerl servers provide access to repositories of things, where a repository is a named collection
of things. Every thing stored within a repository of things must have:
...
All things stored within a repository must have a type. Books, people, web pages, articles, and videos are all types of
things.
...
## 3. ID
Each thing stored within a repository has its own unique identifier.
